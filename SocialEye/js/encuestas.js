...
encuestas.loadWidget = function () {
        ...
        $.each(data, function (i, item) {
            ...
            elementosEncuestas[item.pk]=item.element;
            listaEncuestas += "<li><button type='button' id='"+item.pk+ "' class='list-group-item socialEye filaEncuesta'> <div class='tituloEncuesta'>" + object.description + "</div>  <div class='subtituloEncuesta'> creada por " + item.username + " el "+ item.date+ "  </div> </button></li>";
        });
        listaEncuestas += "</div>";
        listaEncuestas += "</div>";
...
encuestas.onReady = function () {
    $(document.body).on('click', '.filaEncuesta' ,function(){
            ...
            questions=elementosEncuestas[idEncuestaActual]['questions'];
            $('#vote').modal('show');
            siguientePregunta();
...
function siguientePregunta(){
        if (numPreguntaEncuesta<questions.length){
            ...
            $.each(questions[numPreguntaEncuesta]['options'], function (index, option) {
                ...
                opciones+="<label>";
                opciones+="<input id='"+index+"' class='"+questions[numPreguntaEncuesta]['pk']+"' type='radio' name='optionsRadios'/>";
